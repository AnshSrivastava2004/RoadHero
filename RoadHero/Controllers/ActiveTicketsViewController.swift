...
class ActiveTicketsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    
    @IBOutlet var NoActiveTicketsLabel: UILabel!
    ...
    override func viewDidLoad() {
        ...
        view.bringSubviewToFront(NoActiveTicketsLabel)
    ...
    private func fetchTickets() {
        ...
        Task {
            do {
                let fetchedTickets = try await ticketService.fetchTickets(for: user, status: "ACTIVE")
                
                await MainActor.run {
                    self.tickets = fetchedTickets
                    self.NoActiveTicketsLabel.isHidden = !fetchedTickets.isEmpty
